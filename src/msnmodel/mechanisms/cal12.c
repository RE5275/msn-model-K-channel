...
#define nrn_init _nrn_init__cal12
#define _nrn_initial _nrn_initial__cal12
#define nrn_cur _nrn_cur__cal12
#define _nrn_current _nrn_current__cal12
#define nrn_jacob _nrn_jacob__cal12
#define nrn_state _nrn_state__cal12
#define _net_receive _net_receive__cal12 
#define rates rates__cal12 
#define states states__cal12 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal12", _hoc_setdata,
 "ghk_cal12", _hoc_ghk,
 "modulation_cal12", _hoc_modulation,
 "rates_cal12", _hoc_rates,
 0, 0
};
#define ghk ghk_cal12
#define modulation modulation_cal12
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal12 cal12.mod\n");
...
static int _reset;
static char *modelname = "HVA L-type calcium current (Cav1.2)";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ical = pbar * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cali , calo ) * modulation ( _threadargs_ ) ;
   }
 _current += ical;
...
#if NMODL_TEXT
static const char* nmodl_filename = "cal12.mod";
static const char* nmodl_file_text = 
