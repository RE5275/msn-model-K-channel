...
#define modulation modulation_gaba
 extern double modulation( _threadargsproto_ );
 /* declare global and static user variables */
#define q q_gaba
 double q = 2;
#define tau2 tau2_gaba
 double tau2 = 7.5;
#define tau1 tau1_gaba
 double tau1 = 0.5;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 gaba gaba.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "GABA synapse";
...
#if NMODL_TEXT
static const char* nmodl_filename = "gaba.mod";
static const char* nmodl_file_text = 
  "TITLE GABA synapse\n"
  "\n"
  "COMMENT\n"
